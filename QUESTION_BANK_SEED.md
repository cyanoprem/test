...
> **Voice-only MVP (locked 2026-05-18).** All 150 questions use `voice_explanation` mode — no typing required. The product matches decibl's voice-only UX exactly: voice in, voice out, like a phone call. SQL/Python questions are phrased as verbal walkthroughs ("walk me through how you would...") rather than code-construction tasks. `textInputType` is `null` on every question.

**Total: 150 questions** — 50 Data Analyst + 50 Data Scientist + 50 SDE Non-Coding. Each is tagged to specific Indian campus recruiters (2024–2026 sources), uses phrasing reported by candidates on GeeksforGeeks / Glassdoor India / AmbitionBox / Medium / Reddit / PrepInsta / DataLemur / InterviewQuery, carries a rubric, follow-ups, voice-only input mode, and a source citation. Difficulty mix per role is ~40% easy / ~40% medium / ~20% hard.

File structure:
- **Original seed (90 questions)** — technical + conceptual mix; SQL/Python questions converted to verbal walkthroughs
- **Extension 1 (60 questions)** — HR / behavioural / project / managerial / situational, voice-only by design
...
[
 ...
 "textInputType": null,
 "text": "From an Employees(emp_id, name, dept, salary) table, walk me through how you would construct a SQL query to find the second highest salary in each department — explain the approach, key SQL functions you would use, and any edge cases",
 "rubric": [
 ...
 "inputModes": ["voice_explanation"],
 "textInputType": null,
 "text": "Walk me through how you would construct a SQL query to detect duplicate rows in a transactions table on (user_id, txn_time, amount) and keep only the first occurrence — explain the approach, key SQL functions you would use, and any edge cases",
 "rubric": [
 ...
 "inputModes": ["voice_explanation"],
 "textInputType": null,
 "text": "Given a pandas DataFrame df with columns ['city','sales'], walk me through how you would write code to compute total sales per city and return top 3 cities by sales — explain the approach and key steps",
 "rubric": [
...
[
 ...
 "inputModes": ["voice_explanation"],
 "textInputType": null,
 "text": "Given a DataFrame with features and a binary target, walk me through how you would write code to train a Logistic Regression and print precision, recall, and ROC-AUC on a test split — explain the approach and key steps",
 "rubric": [
 ...
 "inputModes": ["voice_explanation"],
 "textInputType": null,
 "text": "Walk me through how you would implement k-NN classifier from scratch in NumPy (no sklearn). Predict on a single test point given training X, y and k — explain the algorithm, the steps, and the data structures involved",
 "rubric": [
 ...
 "inputModes": ["voice_explanation"],
 "textInputType": null,
 "text": "Given X_train, y_train and a list of candidate models, walk me through how you would write code to pick the best by 5-fold cross-validated F1 score — explain the approach and key steps",
 "rubric": [
...
[
 ...
 "inputModes": ["voice_explanation"],
 "textInputType": null,
 "text": "If you had to walk me through how you would build a dashboard around your project's model for ongoing monitoring, what would be on it and why? — describe your approach, the key components, and any trade-offs",
 "rubric": [
